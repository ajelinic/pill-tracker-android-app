...
```bash
# 1) Create an empty repo on GitHub named: pill-tracker-android
# 2) Then push this project

cd pill-tracker-android
git init
git add .
git commit -m "Initial commit: Pill Tracker"
git branch -M main
git remote add origin https://github.com/ajelinic/pill-tracker-android.git
